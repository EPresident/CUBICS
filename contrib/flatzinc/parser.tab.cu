...
{
       0,   435,   435,   437,   439,   442,   443,   447,   448,   452,
     453,   455,   457,   460,   461,   468,   470,   472,   475,   476,
     479,   482,   483,   484,   485,   488,   489,   490,   491,   494,
     495,   498,   499,   505,   505,   508,   541,   570,   575,   605,
     612,   619,   628,   687,   739,   746,   803,   816,   829,   836,
     850,   854,   869,   893,   894,   898,   900,   903,   903,   905,
     909,   911,   926,   950,   951,   955,   957,   961,   965,   967,
     982,  1006,  1007,  1011,  1013,  1016,  1019,  1021,  1036,  1060,
    1061,  1065,  1067,  1070,  1075,  1076,  1081,  1082,  1087,  1088,
    1093,  1094,  1098,  1112,  1125,  1147,  1149,  1151,  1157,  1159,
    1172,  1173,  1180,  1182,  1189,  1190,  1194,  1196,  1201,  1202,
    1206,  1208,  1213,  1214,  1218,  1220,  1225,  1226,  1230,  1232,
    1240,  1242,  1246,  1248,  1253,  1254,  1258,  1260,  1262,  1264,
    1266,  1315,  1329,  1330,  1334,  1336,  1344,  1355,  1377,  1378,
    1386,  1387,  1391,  1393,  1397,  1401,  1405,  1407,  1411,  1413,
    1417,  1419,  1421,  1423,  1425,  1468,  1479
};
#endif
...
yyreduce:
  ...
  case 35:

    {
        ...
        if ((yyvsp[-1].argVec)) {
          print = (yyvsp[-1].argVec)->hasAtom("output_var");
          introduced = (yyvsp[-1].argVec)->hasAtom("var_is_introduced");
        }
